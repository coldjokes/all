...
INSERT INTO `dosth`.`menu` (`id`, `code`, `icon`, `is_menu`, `is_open`, `is_use`, `levels`, `name`, `num`, `pcode`, `pcodes`, `system_info_id`, `tips`, `url`) VALUES ('407', 'inventoryQuery', NULL, '', '\0', '', '2', '盘点记录', '1', 'query', '[query],', '2', NULL, '/inventory/query');
INSERT INTO `dosth`.`menu` (`id`, `code`, `icon`, `is_menu`, `is_open`, `is_use`, `levels`, `name`, `num`, `pcode`, `pcodes`, `system_info_id`, `tips`, `url`) VALUES ('408', 'useRecordSummary', NULL, '', '\0', '', '2', '领用汇总', '1', 'query', '[query],', '2', NULL, '/useRecordSummary');
INSERT INTO `dosth`.`menu` (`id`, `code`, `icon`, `is_menu`, `is_open`, `is_use`, `levels`, `name`, `num`, `pcode`, `pcodes`, `system_info_id`, `tips`, `url`) VALUES ('409', 'feedRecordSummary', NULL, '', '\0', '', '2', '补料汇总', '1', 'query', '[query],', '2', NULL, '/feedRecordSummary');
INSERT INTO `dosth`.`menu` (`id`, `code`, `icon`, `is_menu`, `is_open`, `is_use`, `levels`, `name`, `num`, `pcode`, `pcodes`, `system_info_id`, `tips`, `url`) VALUES ('410', 'categorySummary', NULL, '', '\0', '', '2', '领用途径汇总', '1', 'query', '[query],', '2', NULL, '/useRecordSummary/category');
INSERT INTO `dosth`.`menu` (`id`, `code`, `icon`, `is_menu`, `is_open`, `is_use`, `levels`, `name`, `num`, `pcode`, `pcodes`, `system_info_id`, `tips`, `url`) VALUES ('411', 'deptSummary', NULL, '', '\0', '', '2', '领用部门汇总', '1', 'query', '[query],', '2', NULL, '/useRecordSummary/dept');
