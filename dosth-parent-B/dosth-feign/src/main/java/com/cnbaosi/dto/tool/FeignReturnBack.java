...
public class FeignReturnBack {
	...
	public FeignReturnBack() {
		
	}
	
	public FeignReturnBack(String accountId, String accountName, String matId, String matName, String matSpec, String matBarcode, 
