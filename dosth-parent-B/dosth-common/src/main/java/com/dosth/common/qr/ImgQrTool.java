    ...
    public static void main(String[] args) throws IOException {
        for (int i = 1; i <= 1; i++) {
            QrImage para = new QrImage.Builder()
                    .setFileOutputPath("D:\\"+new Date().getTime()+".jpg")
                    .setQrContent("4028814769a2fc850169a30d2ef50000:297e5a8667960b070167969f51620013:6,3-2;")
                    .setQrHeight(200)
                    .setQrWidth(200)
//                    .setQrIconFilePath("d:\\ZAZFinger.png")
                    .setTopWrodHeight(100)
                    .setWordContent("自定义二维码-----1")
