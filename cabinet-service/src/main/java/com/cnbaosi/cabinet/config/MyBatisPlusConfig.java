...
import com.cnbaosi.cabinet.config.db.MultipleDataSource;
 ...
 */
@Configuration
@MapperScan("com.cnbaosi.cabinet.mapper*")
public class MyBatisPlusConfig {
    ...
    public SqlSessionFactory sqlSessionFactory() throws Exception {
        ...
        //配置类型别名
        sqlSessionFactory.setTypeAliasesPackage("com.cnbaosi.cabinet.entity.model");
        
        // 配置mapper的扫描，找到所有的mapper.xml映射文件
        Resource[] resources = new PathMatchingResourcePatternResolver() .getResources("classpath:/com/cnbaosi/cabinet/mapper/*.xml");
    ...
    public GlobalConfiguration globalConfiguration() {
        ...
        conf.setTablePrefix("bs_"); //全局表前缀配置
        return conf;
    }
